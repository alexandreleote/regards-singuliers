 ...
 */
final class Version20250325074643 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bot_ip (id INT AUTO_INCREMENT NOT NULL, ip VARCHAR(45) NOT NULL, detected_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', user_agent VARCHAR(255) DEFAULT NULL, form_type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
