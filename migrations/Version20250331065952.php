 ...
 */
final class Version20250331065952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE bot_ip (id INT AUTO_INCREMENT NOT NULL, ip VARCHAR(45) NOT NULL, detected_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', user_agent VARCHAR(255) DEFAULT NULL, form_type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE `contact` (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(20) NOT NULL, civilite VARCHAR(20) NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, email VARCHAR(180) NOT NULL, telephone VARCHAR(20) NOT NULL, entreprise VARCHAR(100) DEFAULT NULL, localisation VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', is_read TINYINT(1) NOT NULL, is_responded TINYINT(1) NOT NULL, read_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', responded_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, service_id INT NOT NULL, booked_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', status VARCHAR(50) DEFAULT 'en attente' NOT NULL, price NUMERIC(6, 2) NOT NULL, stripe_payment_intent_id VARCHAR(255) DEFAULT NULL, calendly_event_id VARCHAR(255) DEFAULT NULL, calendly_invitee_id VARCHAR(255) DEFAULT NULL, appointment_datetime DATETIME NOT NULL, INDEX IDX_42C84955A76ED395 (user_id), INDEX IDX_42C84955ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
