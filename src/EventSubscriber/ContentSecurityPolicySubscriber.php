...
class ContentSecurityPolicySubscriber implements EventSubscriberInterface
{
    ...
    public function onKernelResponse(ResponseEvent $event): void
    {
        ...
        $csp = [
            ...
            "connect-src 'self' wss://127.0.0.1:8000 https://127.0.0.1:8000 http://127.0.0.1:8000 https://*.calendly.com https://calendly.com https://maps.googleapis.com https://maps.gstatic.com https://api-adresse.data.gouv.fr",
